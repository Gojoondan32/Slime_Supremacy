...
public class Enemy : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (Physics2D.Raycast(transform.position, -Vector2.up, 2f, waterMask) && movingLeft == true)
        {
        ...
        else if (Physics2D.Raycast(transform.position, -Vector2.up, 2f, waterMask) && movingRight == true)
        {
